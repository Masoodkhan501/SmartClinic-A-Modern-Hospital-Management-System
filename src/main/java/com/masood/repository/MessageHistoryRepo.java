...
public interface MessageHistoryRepo extends JpaRepository<MessageHistory, Long>
{
	...
	@Query("select mh from MessageHistory mh where mh.message.subject = :message")
	...
	public List<MessageHistory> findByUpdatedAt(LocalDate date);
	    ...
	    // Get by date
	public List<MessageHistory> findByUpdatedAtBetween(LocalDate start, LocalDate end);
